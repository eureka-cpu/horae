  ...
  surfaces.map((surface) => () =>
    agent(
      [
        ...
        'components, stay data-honest, then run the cleanup & framework-consistency',
        'review (delete page CSS that re-expresses utilities, de-duplicate new',
        'classes against existing utilities/tokens/components) before verifying with',
